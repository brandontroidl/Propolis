...
Source-available means the source is published and readable, but the license
restricts use (here: noncommercial only). It is not an OSI open-source license,
which would permit commercial use.

## Warranty and contributions
